...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template match="dri:body/dri:div[@id='cz.muni.ics.digilib.aspects.CommunityAspect.div.community-view' and @rend='top-comm']">
        <xsl:variable
            ...
            <div class="col-sm-10">
                <dl class="dl-horizontal">
                    ...
                    >
                        ...
                        <dd class="col-xs-12 col-md-9">
                            <a target="_blank" href="{document($externalMetadata)/mets:METS/mets:dmdSec/mets:mdWrap/mets:xmlData/dim:dim/dim:field[@element='description' and @qualifier='uri']}">
                                <xsl:value-of
        ...
        <xsl:choose>
            ...
            -->
            <xsl:when
                test="./dri:div[@id='cz.muni.ics.digilib.aspects.CommunityAspect.div.sub-table' and @rend='left']"
            >
                <h3>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <xsl:for-each
                                    select="./dri:div[@id='cz.muni.ics.digilib.aspects.CommunityAspect.div.sub-table' and @rend='left']/dri:referenceSet[@id='cz.muni.ics.digilib.aspects.CommunityAspect.referenceSet.volume']"
                                >
                                    <xsl:variable
                                        name="volumeMetadata"
                                    >
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <xsl:for-each
                                    select="./dri:div[@id='cz.muni.ics.digilib.aspects.CommunityAspect.div.sub-table' and @rend='right']/dri:referenceSet[@id='cz.muni.ics.digilib.aspects.CommunityAspect.referenceSet.volume']"
                                >
                                    <xsl:variable
                                        name="volumeMetadata"
                                    >
            ...
            <xsl:when
                test="./dri:referenceSet[@id='cz.muni.ics.digilib.aspects.CommunityAspect.referenceSet.community-volumes']"
            >
                <!-- for celebrity -->
                <h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-condensed">
                            <xsl:for-each
                                select="./dri:referenceSet[@id='cz.muni.ics.digilib.aspects.CommunityAspect.referenceSet.community-volumes']/dri:reference"
                            >
                                <xsl:variable
                                    name="volumeMetadata"
                                >
            ...
            <xsl:when
                test="./dri:referenceSet[@id='cz.muni.ics.digilib.aspects.CommunityAspect.referenceSet.collection-list']"
            >
                <xsl:choose>
                    <xsl:when
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table class="table table-condensed monograph-table">
                                    <xsl:for-each
                                        select="./dri:referenceSet[@id='cz.muni.ics.digilib.aspects.CommunityAspect.referenceSet.collection-list']/dri:reference"
                                    >
                                        <xsl:variable
                                            name="collectionMetadata"
                                        >
            ...
            <xsl:otherwise>
                <div class="row">
                    <div class="col-xs-12 alert alert-info no-entry-alert">
                        <h2>
                            <i18n:text>page.community.noentry.head</i18n:text>
                        </h2>
                        <i18n:text>page.error.noentries</i18n:text>
                    </div>
                </div>
            </xsl:otherwise>
        </xsl:choose>
    ...
    <xsl:template match="dri:body/dri:div[@id='cz.muni.ics.digilib.aspects.CommunityAspect.div.community-view' and @rend='volume']">
        <xsl:variable
            name="volumeMetadata"
        >
            <xsl:text>cocoon://</xsl:text>
            <xsl:value-of select="./dri:referenceSet[@id='cz.muni.ics.digilib.aspects.CommunityAspect.referenceSet.volume']/dri:reference[@type='DSpace Community']/@url"/>
            <xsl:text>?sections=dmdSec</xsl:text>
        </xsl:variable>
        <xsl:variable
        ...
        >
            <xsl:text>cocoon://</xsl:text>
            <xsl:value-of select="./dri:referenceSet[@id='cz.muni.ics.digilib.aspects.CommunityAspect.referenceSet.parent-community']/dri:reference[@type='DSpace Community']/@url"/>
            <xsl:text>?sections=dmdSec</xsl:text>
        </xsl:variable>
        <xsl:choose>
            <xsl:when
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="list-group">
                            ...
                            <xsl:for-each
                                select="./dri:referenceSet[@id='cz.muni.ics.digilib.aspects.CommunityAspect.referenceSet.issues']/dri:reference[@type='DSpace Collection']"
                            >
                                <xsl:variable 
                                    name="collectionMetadata"
                                >
                                ...
                                <a class="list-group-item" href="{document($collectionMetadata)/mets:METS/@OBJID}">
