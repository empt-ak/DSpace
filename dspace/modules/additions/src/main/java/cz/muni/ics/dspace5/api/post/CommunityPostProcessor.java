...
public interface CommunityPostProcessor
{
     ...
     *                                  community is null.
     */
    void processCommunity(ObjectWrapper objectWrapper, Community community, List<ObjectWrapper> parents, Map<String,Object> dataMap) throws IllegalArgumentException;
}
